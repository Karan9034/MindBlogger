...
from flask_blog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, ResetForm, ResetPWForm
...
# def delete_picture(pic):
#     picture_path = os.path.join(app.root_path, 'static/profile_pics', pic)
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset', sender='mindblogger@hotmail.com', recipients=[user.email])
